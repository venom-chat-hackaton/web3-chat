...
contract Chat {
    event NewMessage(string fromAddress, string toAddress, string msg, string uuid);
    ...
    function sendMessage(string from, string dest, string message, string uuid) external {
        tvm.accept();
